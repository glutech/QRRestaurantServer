...
<%
	if(new AdminAuthService(request.getSession()).isAuth()) {
...
<html lang="zh-cn" id="page-login">
    ...
    <body>
        ...
        <script src="./../AdminPublic/jQuery/jquery-1.10.2.min.js"></script>
        <script src="./../AdminPublic/Bootstrap/dist/js/bootstrap.min.js"></script>
        <script src="./../AdminPublic/Validation/jquery.validate.min.js"></script>
        <script src="./../AdminPublic/common.min.js"></script>
