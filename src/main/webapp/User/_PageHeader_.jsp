            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li<%=_activeAction.equals("餐桌") ? " class=\"active\"" : ""%>><a href="./page-board.html"><span class="glyphicon glyphicon-cutlery"></span>餐桌</a></li>
                        ...
                        <li class="dropdown<%=(_activeAction.equals("餐桌管理") || _activeAction.equals("菜品管理")) ? " active" : ""%>">
                            <a class="dropdown-toggle" href="#" data-toggle="dropdown"><span class="glyphicon glyphicon-cog"></span>管理<b class="caret"></b></a>
                            <ul class="dropdown-menu">
                                <li<%=_activeAction.equals("餐桌管理") ? " class=\"active\"" : ""%>><a href="./page-board-list.html">餐桌管理</a></li>
                                <li<%=_activeAction.equals("菜品管理") ? " class=\"active\"" : ""%>><a href="./page-dish-list.html">菜品管理</a></li>
                            </ul>
                        </li>
                    </ul>
